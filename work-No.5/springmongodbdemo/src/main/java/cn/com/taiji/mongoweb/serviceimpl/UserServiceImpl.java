...
//    @Override
//    public List<DBObject> withinMultiPolygon(String collection, String locationField, List<double[]> polygon, List<double[]> polygon1, DBObject fields, DBObject query, int limit) {
//        return userDao.withinMultiPolygon(collection,locationField,polygon,polygon1,fields,query,limit);
//    }
